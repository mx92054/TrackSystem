    ...
    public class SqLiteHelper
    {
        ...
        public SqLiteHelper(string connectionString)
        {
            try
            {
                ...
                dbConnectionstr.DataSource = @"./Data/" + connectionString;
        ...
        /// <summary>
        /// Reads maxium value of item from table.
        /// </summary>
        /// <returns>The table.</returns>
        /// <param name="tableName">Table name.</param>
        ...
        /// <param name="operations">Operations.</param>
        /// <param name="colValues">Col values.</param>
        public SQLiteDataReader ReadMaxValue(string tableName, string item)
        {
            string queryString = string.Format("SELECT max({0}) FROM {1}", item, tableName);
            return ExecuteQuery(queryString);
        }
        ...
        {
            frMain.WriteLog("class SqLiteHelper:::" + s);
        }
